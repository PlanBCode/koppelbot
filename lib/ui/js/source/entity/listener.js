...
function ListenerHandler() {
    ...
    const callListners = (eventName, entityId, listenerEntityId) => {
        if (listenersPerEntityIdPerEventName.hasOwnProperty(listenerEntityId)) {
            ...
            if (listenersPerEventName.hasOwnProperty(eventName)) {
                ...
                listeners.forEach(callback => callback(entityId, eventName));
            }
        }
    };
    ...
    this.callListeners = (state, entityId) => {
        ...
        callListners(eventName, entityId, '*');
        callListners(eventName, entityId, entityId)
    };
