    ...
    this.renderUiElement = (action, options, source, xyz, entityId) => {
        ...
        if (types.hasOwnProperty(type)) {
            ...
            if (types[type].hasOwnProperty(action)) {
                ...
                return types[type][action](xyz, uri, content, settings, options, onChange);
                ...
                for (let subPropertyName in subProperties) {
                    ...
                    const element = subProperty.renderUiElement(action, options, subPropertySource, xyz, entityId);
