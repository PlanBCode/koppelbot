...
exports.constructor = function Property(parent, propertyName, meta, entityClass, parentUri) {
    ...
    if (settings.hasOwnProperty('signature')) {
        ...
        for (let propertyName in settings.signature) {
            subProperties[propertyName] = new Property(this, propertyName, settings.signature[propertyName], entityClass, uri);
        }
    }
