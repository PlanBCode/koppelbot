...
const ListenerHandler = require('./listener.js').handler;

exports.constructor = function Entity(entityClassName, settings) {
    ListenerHandler.call(this);
    ...
    this.createEntityIdResponse = (entityId, entityStatus, entityContent) => {
        //this.callListeners(entityId, type, entityStatus, entityContent)
        ...
        if (entityStatus === 207) {
            for (let propertyName in properties) {
                ...
                if (property207Wrapper === null || typeof property207Wrapper !== 'object'
                    ...
                    const propertyResponse = property.createResponse(entityId, propertyStatus, propertyContent);
        ...
        if (entityClassStatus === 207) {
            for (let entityId of entityIds) {
                ...
                if (entity207Wrapper === null || typeof entity207Wrapper !== 'object'
                    ...
                    const entityResponse = this.createEntityIdResponse(entityId, entityStatus, entityContent);
