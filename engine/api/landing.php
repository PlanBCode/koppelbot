...
function APILandingHtml($full = true){
  ...
  <tr class="xyz-list-header xyz-list-foldable" id="xyz-apie-request-header" ><td colspan="3">Request</td></tr>
  ...
  <tr class="xyz-list-header xyz-list-foldable xyz-list-folded" id="xyz-api-filters"><td>Query Filter</td><td>Operator</td><td>Value</td></tr>

  <tr class="xyz-list-header xyz-list-foldable xyz-list-folded" id="xyz-api-apiOptions"><td>Query Option</td><td>Description</td><td>Value</td></tr>';
  ...
  <tr class="xyz-list-header xyz-list-foldable"><td colspan="3">Response</td></tr>
